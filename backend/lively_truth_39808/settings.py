"""
Django settings for lively_truth_39808 project.
...
ROOT_URLCONF = 'lively_truth_39808.urls'
...
WSGI_APPLICATION = 'lively_truth_39808.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lively_truth_39808 API",
    "DESCRIPTION": "API documentation for lively_truth_39808 App",
    "VERSION": "v1",
}
